...
//     var box = Hive.box<SongFavorite>('song_favorite_box');
//     List<Song> existingSongs = (box.get(0)?.song as List<Song>) ?? [];
//     return existingSongs.contains(song);
//   }

//   void toggleFavorite() {
//     Song currentSong = widget.songdata;

//     Box<SongFavorite> box = Hive.box<SongFavorite>('song_favorite_box');
//     List<Song> existingSongs = (box.get(0)?.song as List<Song>) ?? [];


//     if (isSongFavorite(currentSong)) {
//       existingSongs.remove(currentSong);
//       setState(() {
//         isFavorite = false;
//       });
//       print('Song removed from favorites: ${currentSong.name}');
//     } else {
//       existingSongs.add(currentSong);
//       setState(() {
//         isFavorite = true;
//       });
//       print('Song added to favorites: ${currentSong.name}');
//     }

//     box.put(0, existingSongs as SongFavorite);

//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(
//         content: Text(isFavorite ? 'Song added to favorites!' : 'Song removed from favorites!'),
//       ),
//     );
//   }
...
//                               // favorite
//                               IconButton(
//                                   onPressed: toggleFavorite, // Call the toggleFavorite function
//                                   icon: isSongFavorite(widget.songdata)
//                                       ? SvgPicture.asset('assets/pics/Fav_filled.svg') // Change the icon for favorited songs
//                                       : SvgPicture.asset('assets/pics/Fav.svg')),
//                               IconButton(
//                                       splashColor: Colors.transparent,
//                                       highlightColor: Colors.transparent,
//                                     onPressed: () async {
